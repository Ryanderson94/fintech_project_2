...
while True:
    ...
    # Assign a copy of technical varaible columns to the Trading Features dataframe and lag it
    X_trading = bars_trading[['sma_short_window', 'sma_long_window', 'RSI', 'EMA', ]].shift(shift_time).dropna().copy()
    ...
    # We can probably get rid of this, i assume
    # (1 + bars['Strategy_Returns']).cumprod().plot()
    # (1 + bars['contrarian_Strategy_Returns']).cumprod().plot()
